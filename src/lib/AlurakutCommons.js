...
// Menu
// ================================================================================================================
export function AlurakutMenu({ usuarioAleatorio }) {
  ...
  return (
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      ...
      <AlurakutMenuProfileSidebar usuarioAleatorio={usuarioAleatorio} />
...
function AlurakutMenuProfileSidebar({ usuarioAleatorio }) {
  return (
